    ...
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                ...
                <div class="user-info">
                    <h4 class="font-weight-semibold mt-3 mb-0">moahmmed</h4>
                    <span class="mb-0 text-muted">mohammed.aljaoor@gmail.com</span>
                </div>
            </div>
        </div>
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'user/index')) }}">قائمة المستخدمين</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'products/view')) }}">المنتجات</a></li>
                </ul>
            </li>
        </ul>
    </div>
